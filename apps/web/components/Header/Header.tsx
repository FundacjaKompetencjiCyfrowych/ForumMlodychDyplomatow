...
const Header = async () => {
  ...
  return (
    ...
    >
      <div className="relative isolate z-80 grid h-header-height-mobile w-full max-w-full grid-cols-2 items-center px-6 md:h-header-height-mobile md:grid-cols-3 md:px-12">
