...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        primary:
          "active:brand-red-800 bg-brand-red-900 text-white hover:bg-brand-red-700 disabled:bg-brand-red-50 disabled:text-gray-400",
        secondary:
          "border border-brand-red-900 bg-transparent text-brand-red-900 hover:border-brand-red-700 hover:text-brand-red-700 active:border-brand-red-800 active:text-brand-red-800 disabled:border-brand-red-200 disabled:text-red-200",
        text: "border-transparent bg-transparent text-brand-red-900 hover:text-brand-red-700 active:text-brand-red-900 disabled:text-gray-400",
        page: [
        ...
        link: "text-gray-900 underline hover:text-brand-red-800 active:text-brand-red-900",
        // not updated yet
      ...
      size: {
        s: "h-13 gap-1 px-4 text-[0.75rem]",
        m: "h-10 gap-1.5 px-5 text-[0.875rem]",
        l: "h-8 gap-2 px-6 text-[1rem]",
        inline: "",
        "icon-sm": "p-1.5",
      },
    },
