      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          [
            ...
            "data-[side=left]:inset-y-0 data-[side=left]:left-0 data-[side=left]:w-screen data-[side=left]:border-r",
            "data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:w-screen data-[side=right]:border-l",
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" asChild>
            <Button variant="ghost" className="absolute top-3 right-3" size="m">
              <XIcon />
