...
export const typographyVariants = cva("", {
  variants: {
    variant: {
      ...
      "body-xl": "text-[1.125rem] leading-[1.55] desktop:text-[1.25rem]",
      "body-l": "text-[1rem] leading-[1.55] desktop:text-[1.125rem]",
      ...
      "title-s": "text-[0.875rem] leading-normal font-semibold desktop:text-[1rem]",
